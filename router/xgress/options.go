...
func DefaultOptions() *Options {
	return &Options{
		...
		Drop1InN:               100,
		TxQueueSize:            1,
		TxPortalStartSize:      64 * 1024,
		TxPortalMinSize:        16 * 1024,
		TxPortalMaxSize:        16 * 1024 * 1024,
		TxPortalIncreaseThresh: 64,
		TxPortalIncreaseScale:  4.0,
		TxPortalRetxThresh:     128,
		TxPortalRetxScale:      0.75,
		TxPortalDupAckThresh:   128,
		TxPortalDupAckScale:    0.85,
		RxBufferSize:           16 * 1024 * 1024,
		RetxStartMs:            200,
		RetxScale:              2.0,
		RetxAddMs:              100,
