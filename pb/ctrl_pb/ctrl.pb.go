...
type SessionRequest struct {
	...
	EgressHints          map[uint32][]byte `protobuf:"bytes,3,rep,name=egressHints,proto3" json:"egressHints,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (m *SessionRequest) GetEgressHints() map[uint32][]byte {
	if m != nil {
		return m.EgressHints
	}
	return nil
}
...
func (m *BindRequest) GetPubkey() []byte {
	if m != nil {
		return m.Pubkey
	}
	return nil
...
type Route_Egress struct {
	...
	Hints                map[uint32][]byte `protobuf:"bytes,4,rep,name=hints,proto3" json:"hints,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *Route_Egress) GetHints() map[uint32][]byte {
	if m != nil {
		return m.Hints
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[uint32][]byte)(nil), "ctrl.pb.SessionRequest.EgressHintsEntry")
	...
	proto.RegisterMapType((map[uint32][]byte)(nil), "ctrl.pb.Route.Egress.HintsEntry")
...
var fileDescriptor_a0572e205f89e843 = []byte{
	...
	,
}
